class WorkController < ApplicationController
  ...
  def index
    ...
    @selected_image_name = 'The Velvet Underground - The Velvet Underground & Nico'
  ...
  def display_theme
    ...
    if params[:theme] == "-----"
      ...
      data = { index: 0, name: 'The Velvet Underground - The Velvet Underground & Nico', values_qty: values_qty,
               file: 'The Velvet Underground - The Velvet Underground & Nico.jpg', image_id: 4,
